...
public struct AppDefaultDependencies {
    let bundle = Bundle(identifier: "jp.co.curiosity.Sample1")
...
extension AppDefaultDependencies: AppDependencies {
    public func assembleGithubRepoSearchModule() -> UIViewController {
        ...
        let presenter = GithubRepoSearchPresenter(dependency: .init(
            wireframe: router,
            githubRepoSearchUseCase: GithubRepoSearchInteractor()
        ))
